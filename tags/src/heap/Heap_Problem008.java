 ...
 */
public class Heap_Problem008 {
    public static void main(String[] args) {
        int[][] a = {{2, 5, 2, 8, 5, 6, 8, 8}, {4, 3, 2, 6}};
        for (int i = 0; i < a.length; i++) {
            int[] arr = a[i];
            System.out.println(connectRopesToMinimizeCost(arr));
        }
    }

    private static int connectRopesToMinimizeCost(int[] arr) {
